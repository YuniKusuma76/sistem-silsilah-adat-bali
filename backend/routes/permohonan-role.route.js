...
import {
  ...
  batalkanPermohonan,
  hapusRiwayatPermohonan,
  getDokumenPendukung,
  getAllPermohonan,
  getPermohonanSaya,
  getDetailPermohonan
} from "../controllers/permohonan-role.controller.js";
import { verifyToken, superAdminOnly } from "../middlewares/verification.middleware.js";
...
router.delete("/:id", verifyToken, hapusRiwayatPermohonan);
