...
const AdminAturanAdatBali = () => {
  ...
  const createSlug = (item) => {
    // Gunakan Kode Kondisi sebagai bagian dari nama slug
    const name = item.status_peran_adat || 'Aturan';
  ...
  const filteredData = data.filter(item => {
    ...
    return (
      (item.kode_kondisi?.toLowerCase() || '').includes(search) ||
      (item.status_peran_adat?.toLowerCase() || '').includes(search) ||
      (item.garis_keturunan?.toLowerCase() || '').includes(search)
    );
  });
      ...
      <div className="p-8 flex-1">
        <div className="main-title">
          ...
          <p className="text-gray-600 text-md mb-5">
            Aturan adat untuk menentukan status peran Adat Bali
          </p>
        </div>
        {/* Search Bar */}
            ...
            <table className="min-w-full w-full">
              <thead>
                <tr className="thead-tr">
                  ...
                  <th className="thead-th text-center" style={{ width: '10%' }}>Action</th>
                </tr>
              </thead>
                  ...
                  <tr>
                    <td colSpan="6" className="text-center py-10 text-gray-500">
                      <div className="flex flex-col items-center">
                        ...
                        <p>{searchTerm ? `Data ${searchTerm} tidak ditemukan` : "Tidak Ada Aturan Adat Bali"}</p>
                      </div>
                    </td>
                  </tr>
                ) : (
                        ...
                        <div className="flex justify-center gap-2">
                          <button 
                            ...
                            onClick={() => {
                              ...
                              navigate(`/aturan-adat/list/detail/${slug}`);
                            }}
                          >
                            <FaInfoCircle /> Detail
                          </button>
...
export default AdminAturanAdatBali;