...
// 1. Gunakan axiosInstance agar konsisten dengan modul lain
import axiosInstance from '../api/axiosInstance.js'; 
import { 
  FaArrowLeft, FaBook, FaUserTie, FaCheckCircle, 
  FaTimesCircle, FaGavel, FaQuoteLeft, FaCalendarAlt, FaIdCard
} from 'react-icons/fa';
...
const AdminAturanAdatBaliDetail = () => {
  // State ID
  ...
  useEffect(() => {
    const fetchDetail = async () => {
      ...
      try {
        setLoading(true);
        const response = await axiosInstance.get(`/aturan/${realId}`);
  ...
  // Jika realId gagal di-decode atau data tidak ditemukan
  if (!realId || !data) {
    return (
      <div className="main-container">
        ...
        <p className="text-gray-600 mb-6">
          Aturan adat yang Anda cari tidak tersedia atau URL tidak valid.
        </p>
        <button 
          className="btn-cencel mx-auto" 
      ...
      <div className="p-8 flex-1">
        <div className="main-title">
          ...
          <p className="text-gray-600 text-md">
            Detail aturan adat untuk menentukan status peran Adat Bali
          </p>
        </div>
        {/* Content */}
        ...
        <div className="mt-8 pt-6 flex items-center justify-center">
          <button 
            ...
            onClick={() => navigate('/aturan-adat/list')}
          >
            <FaArrowLeft /> Kembali
          </button>
        </div>
...
export default AdminAturanAdatBaliDetail;