      ...
      <div className={`${styles.cardModal} animate-fade-in`}>
        ...
        <div className="p-7">
          ...
          <div className="mt-6 mb-3 flex justify-center">
            <button 
              onClick={() => onVisualize(krama.id, krama.nama_lengkap, krama.tipe_data)} 
              className={`${styles.btnTreh} w-full`}>
...
const TrehBali = () => {
  ...
  useEffect(() => {
    const fetchLeluhurOptions = async () => {
      try {
        ...
        console.error("Gagal memuat daftar leluhur:", error);
      }
    };
    fetchLeluhurOptions();
  }, []);
  ...
  // Helper: menangani perubahan opsi leluhur
